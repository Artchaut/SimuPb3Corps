...
const std::string MODEL_PATH = "../res/models/sans_nom.obj";
const std::string TEXTURE_PATH = "../res/textures/2k_neptune.png";
...
struct Data {
    ...
    Data(std::vector<ModelData*> models, CameraData& cameraData)
        : cameraData(cameraData)
        , models(models)
    {
    }
...
private:
    ...
    auto mainLoop() -> void
    {
        ...
        auto jupyter = new ModelData("../res/models/sans_nom.obj",
        ...
        auto neptune = new ModelData("../res/models/sans_nom.obj",
        ...
        auto uranus = new ModelData("../res/models/sans_nom.obj",
        ...
        std::vector<ModelData*> models { jupyter, uranus, neptune };

        auto cameraData = new CameraData(90.0, 1.0);

        data = new Data(models, *cameraData);
    ...
    auto recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) -> void
    {
        ...
        ImGui::SliderFloat("Speed", &data->cameraData.speed, 0.0f, 50.0f);
    ...
    auto updateUniformBuffer(uint32_t currentImage) -> void
    {
        ...
        ubo.model = data->models[0]->getModelMatrix();

        ubo.model = glm::rotate(ubo.model, glm::radians(25.0f) * time, glm::vec3(0.0f, 1.0f, 0.0f));
